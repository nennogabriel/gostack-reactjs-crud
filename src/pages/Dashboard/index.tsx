...
const Dashboard: React.FC = () => {
  ...
  async function handleUpdateFood(
    ...
    const changedPlusFoods = [...foods];
    const foodIndex = changedPlusFoods.findIndex(item => item.id === id);
    changedPlusFoods[foodIndex] = response.data;
    setFoods(changedPlusFoods);
  }
